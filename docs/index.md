...
<body>
    <article class="markdown-body">
        ...
        <h1>Education</h1>
        <h2>University of Bari, Italy, <strong>Inter-University Specialization School for Secondary Education</strong> in <strong>Physics, Computer Science, and Mathematics</strong></h2>
        <ul>
