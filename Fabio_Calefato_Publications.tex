...
\usepackage[
    pdftitle={Fabio Calefato - Publications},
...
% Redefine \today to print as "Month Year"
...
% References settings
\usepackage[style=ieee,sorting=ydnt,defernumbers=true,maxnames=99]{biblatex}
\addbibresource{src/bibliography/publications.bib}

% Define filters for publication types
...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Updated$:$ \today}\hspace{\widthof{Updated$:$ \today}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Fabio Calefato - Publications
    ...
    \nocite{*}
    \section{Journal \& Magazine Papers}
