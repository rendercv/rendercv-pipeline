...
\begin{itemize}
\item \textbf{Human-AI Collaboration in Software Engineering:} Building on my work in human factors and empirical software engineering, I will investigate interaction patterns between developers and AI systems, particularly in code generation and repair tasks. This research will establish metrics for human-AI pair programming effectiveness, develop frameworks for AI-assisted code review, and create guidelines for integrating LLMs into development workflows while preserving meaningful human agency.
