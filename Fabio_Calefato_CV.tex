...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Fabio Calefato - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://bateman.github.io/rendercv-pipeline/}{{\footnotesize\faLink}\hspace*{0.13cm}bateman.github.io/rendercv-pipeline}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/fcalefato}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}fcalefato}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{MsC}}{
            ...
            \textbf{University of Bari, Italy}, Computer Science
            \begin{highlights}
    ...
    \section{Publications}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \mbox{Frodo Baggins}, \mbox{\textbf{\textit{Fabio Calefato}}}, \mbox{Samwise Gamgee}
                \vspace{0.10 cm}
